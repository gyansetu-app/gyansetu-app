              ...
              <CardContent>
                <div className='flex flex-col'>
                  ...
                  <div className='flex justify-between mt-3'>
                    <p className='text-xs relative text-(--chart-3)'>Stone 18 - 45% completed</p>
                    <p className='text-xs relative text-(--chart-3)'>34 Stones</p>
                  </div>
              ...
              <CardContent>
                <div className='flex flex-col'>
                  <div className='flex'>
                    ...
                    <div className='ml-3 mr-1 flex flex-col'>
                      <p className='ml-3'>Force and Motion</p>
                      <p className='ml-3'>Teacher: <span className='font-normal'> Mr. Ram Govind</span></p>
                    </div>
                  </div>
                  <div className='flex justify-between mt-3'>
                    <p className='text-xs relative text-(--chart-3)'>Stone 26 - 80% completed</p>
                    <p className='text-xs relative text-(--chart-3)'>30 Stones</p>
                  </div>
        ...
        <div className='mx-5 mt-5'>
          ...
          <div className='flex gap-3 overflow-x-auto pb-3'>
            <ImageCard
              ...
              imageUrl='/learnPage/illustrations/optics.png'></ImageCard>
            <ImageCard
              className='min-w-[200px]'
              caption="Flashcards on pulmonary system"
              imageUrl='/learnPage/illustrations/pulmonary.png'></ImageCard>
            <ImageCard
              className='min-w-[200px]'
              caption="CBSE Class 10 Chemistry Papers"
              imageUrl='/learnPage/illustrations/test_papers.png'></ImageCard>
