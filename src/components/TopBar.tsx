...
export default function TopBar() {
  return (
    <div className="flex items-center justify-between bg-white px-4 py-2 shadow-shadow mb-5">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-1 bg-secondary-background px-1 py-1 rounded-base border-2 border-border shadow-shadow">
          <Flame className="w-4 h-4 text-main" />
          <span className="font-base text-foreground">4</span>
        </div>
